...
Safe Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 5555.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 5554 for connections and services them.
...
However, in open source software such as Safe Core, where everyone uses
...
pay attention to for reviewers of Safe Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Safe Core uses tinyformat, which is type safe. Leave them out to avoid confusion
