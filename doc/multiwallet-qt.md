...
Only requiring some minor changes is safe.cpp.
...
Changes to safe.cpp
----------------------
safe.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
