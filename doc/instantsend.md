...
This mechanism has been integrated into Bitcore-Node-Safe which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/safe/insight-api-safe#web-socket-api](https://github.com/safe/insight-api-safe#web-socket-api)
* API: [https://github.com/safe/insight-api-safe#instantsend-transactions](https://github.com/safe/insight-api-safe#instantsend-transactions)
...
By default, the Safe Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Safe Core daemon:
