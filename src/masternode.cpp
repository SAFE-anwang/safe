...
void CMasternode::Check(bool fForce)
{
    ...
    bool fOurMasternode = false;//fMasterNode && activeMasternode.pubKeyMasternode == pubKeyMasternode;  //XJTODO
...
bool CMasternodeBroadcast::CheckOutpoint(int& nDos)
{
    ...
    // should be at least not earlier than block when 1000 SAFE tx got nMasternodeMinimumConfirmations
