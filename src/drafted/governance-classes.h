 ...
 *
 *   // network
 *   CSafeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://www.anwang.com/)
    int nStatusID;
...
// // root node
class CSafeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SafeNetwork
// //   -- signature requirements : Key1(User)
// class CSafeNetworkVariable : public CGovernanceObject
// {
// private:
