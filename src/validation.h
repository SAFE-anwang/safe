...
void SelectMasterNodeByPayee(unsigned int nCurrBlockHeight, uint32_t nTime,uint32_t scoreTime, const bool bSpork, const bool bProcessSpork,std::vector<CMasternode>& tmpVecResultMasternodes
