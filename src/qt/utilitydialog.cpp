    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Safe Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  safe-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Safe in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SAFE, 0.1 SAFE, 1 SAFE and 10 SAFE -- sort of like the paper money you use every day.</li> \
