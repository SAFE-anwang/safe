...
Note
---------------------
Always use absolute paths to configure and compile Safe Core and the dependencies,
...
install necessary parts of boost:
    ...
    sudo apt-get install libboost-system-dev libboost-filesystem-dev libboost-chrono-dev libboost-program-options-dev libboost-test-dev libboost-thread-dev libprotobuf-dev protobuf-compiler
...
If you want to build Safe-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a safe-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip safed" to strip the debug
...
Security
--------
To help make your Safe installation more secure by making certain attacks impossible to
